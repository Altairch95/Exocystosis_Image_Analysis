...
def optim(LL, x0, d, verbose=True):
    ...
    with warnings.catch_warnings():
        ...
        bnds = ((10, 40), (10, 20))
        opt = minimize(LL, x0, args=d, method="BFGS", bounds=bnds)
    ...
    if high_scored_mu < reject_lower:
        ...
        try:
            ...
            print('\n\n\tThe distance distribution seems a bit noisy, this step could be a bit fishy\n'
                  'Searching again with a cutoff of 2/5 instead of 2/3\n')
            time.sleep(3)
